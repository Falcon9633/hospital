...
public interface ProcedureDao {
    ...
    List<EmployeeProcedureBean> findAllEmployeeProcedureBeansByEmp(Long empId);

    List<PatientProcedureBean> findAllPatientProcedureBeansByPatient(Long patientId);
