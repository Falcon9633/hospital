...
<fmt:message key="employee_assignment.title" var="title" bundle="${lang}"/>
...
<div class="container">
    ...
    <table class="table table-dark table-bordered table-hover">
        <thead>
        <tr>
            <th><fmt:message key="employee_assignment.th.assignment" bundle="${lang}"/></th>
            <th><fmt:message key="employee_assignment.th.type" bundle="${lang}"/></th>
    ...
    <div class="modal fade" id="employeeAssignmentModal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title">
                        <fmt:message key="employee_assignment.modal.title" bundle="${lang}"/>
                    </h3>
                </div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/js/employeeModal.js"></script>
</body>
</html>
